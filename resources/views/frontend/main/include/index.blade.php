...
<html lang="en">
    <head>
        ...
        <!--====== Default css ======-->
        <link rel="stylesheet" href="{{asset('/')}}frontend/main/assets/css/default.css">
        <!--====== Style css ======-->
        <link rel="stylesheet" href="{{asset('/')}}frontend/main/assets/css/style.css">
        <!--====== Responsive css ======-->
        <link rel="stylesheet" href="{{asset('/')}}frontend/main/assets/css/responsive.css">
    </head>
    <body data-spy="scroll" data-target=".main-menu">
        <div class="gradient-body">
            ...
            <div class="offcanvas-panel">
                ...
                <div class="offcanvas-panel-inner">
                    <div class="panel-logo">
                        <a href="index.html"><img src="{{asset(setting('site_logo'))}}" alt="Qempo"></a>
                    </div>
                    <div class="about-us">
                        <h5 class="panel-widget-title">About Us</h5>
                        <p>
                            We bring people together through great food, fresh ingredients, and exceptional service — making every meal memorable.
                        </p>
                    ...
                    <div class="container-fluid">
                        <div class="primary-menu">
                            <div class="site-branding">
                                <a href="index.html" class="brand-logo"><img src="{{asset(setting('site_logo'))}}" alt="Site Logo"></a>
                            </div>
            ...
            <section class="hero-banner-v2 position-relative z-1" id="home">
                <div class="shape shape-one"><span><img src="{{asset('/')}}frontend/main/assets/images/hero/hero-two-shape-1.png" alt=""></span></div>
                <div class="shape shape-two"><span><img src="{{asset('/')}}frontend/main/assets/images/hero/hero-two-shape-2.png" alt=""></span></div>
                <div class="shape shape-three"><span><img src="{{asset('/')}}frontend/main/assets/images/hero/hero-two-shape-3.png" alt=""></span></div>
                <div class="shape shape-four"><span><img src="{{asset('/')}}frontend/main/assets/images/hero/dot-pattern.png" alt=""></span></div>
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="hero-content">
                                <span class="sub-title wow fadeInUp">
                                    <i class="fas fa-arrow-right"></i>Welcome to {{ setting('site_title') }}
                                </span>
                                ...
                                <p class="wow fadeInDown" data-wow-delay="1s">
                                    Launch your restaurant website, accept online orders, manage menus, and grow your business —
                                    all from one powerful platform.
                                </p>

                                <a href="pricing.html" class="main-btn arrow-btn wow fadeInUp" data-wow-delay=".7s">
                                    View Pricing
                                </a>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="hero-img wow fadeInRight" data-wow-delay=".9s">
                                <img src="{{asset('/')}}frontend/main/assets/images/hero/hero-three-img-1-1.png" alt="">
                                <div class="hero-shape hero-shape-one animate-float-x"><span><img src="{{asset('/')}}frontend/main/assets/images/hero/shape-1.png" alt=""></span></div>
                                <div class="hero-shape hero-shape-two animate-float-y"><span><img src="{{asset('/')}}frontend/main/assets/images/hero/shape-2.png" alt=""></span></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                               <div class="section-title text-center mb-55 wow fadeInUp">
                                    <h2>Grow Your Restaurant Digitally</h2>
                                    <p>Manage orders, menus, payments, and customers from one dashboard</p>
                                </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="service-item service-style-two mb-40 wow fadeInUp" data-wow-delay=".15s">
                                    ...
                                    <div class="text">
                                        <h3 class="title"><a href="feature-details.html">Online Ordering</a></h3>
                                        <ul class="list-style-two">
                                            <li>Accept orders from website & app</li>
                                            <li>Real-time notifications</li>
                                            <li>Easy order tracking</li>
                                        </ul>
                                        <a href="feature-details.html" class="btn-link">Read More</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="service-item service-style-two mb-40 wow fadeInUp" data-wow-delay=".20s">
                                    ...
                                    <div class="text">
                                        <h3 class="title"><a href="feature-details.html">Menu Management</a></h3>
                                        <ul class="list-style-two">
                                            <li>Add & edit dishes easily</li>
                                            <li>Set prices, offers & availability</li>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="service-item service-style-two mb-40 wow fadeInUp" data-wow-delay=".25s">
                                    ...
                                    <div class="text">
                                        <h3 class="title"><a href="feature-details.html">Dashboard & Analytics</a></h3>
                                        <ul class="list-style-two">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="img-holder mb-50 wow fadeInLeft">
                                <div class="shape shape-one animate-float-y"><span><img src="{{asset('/')}}frontend/main/assets/images/shape/shape-5.png" alt=""></span></div>
                                <img src="{{asset('/')}}frontend/main/assets/images/about/about-3.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="text-wrapper mb-50 wow fadeInRight">
                                <div class="section-title mb-25">
                                    <h2>Helping Restaurants Grow Digitally</h2>
                                    <p class="blue-dark">All-in-one SaaS platform for restaurant owners</p>
                                </div>
                                <p>
                                    Our platform empowers restaurant owners to manage orders, menus, payments, and customers efficiently.
                                    With easy-to-use tools and real-time analytics, you can focus on growing your business, while we handle the technology.
                                </p>
                                <ul class="list-style-one mb-40">
                                    <li>Online Ordering & Menu Management</li>
                                    <li>Customer Insights & Analytics</li>
                                    <li>Easy Website & Digital Presence</li>
                                </ul>
                                <a href="about.html" class="main-btn bordered-btn btn-blue">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row portfolio-grid">
                        <div class="col-lg-4 col-md-6 col-sm-12 cat-1 portfolio-column cat-3">
                            <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".1s">
                                <div class="img-holder">
                                    <img src="{{asset('/')}}frontend/main/assets/images/portfolio/img-10.jpg" alt="Img">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-2 cat-4">
                            <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".2s">
                                <div class="img-holder">
                                    <img src="{{asset('/')}}frontend/main/assets/images/portfolio/img-11.jpg" alt="Img">
                                    <div class="portfolio-hover">
                                        <div class="hover-content">
                                            <a href="#" class="cat-btn">Design</a>
                                            <h4><a href="project-details.html">Creative Arts</a></h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-3 cat-4">
                            <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".3s">
                                <div class="img-holder">
                                    <img src="{{asset('/')}}frontend/main/assets/images/portfolio/img-12.jpg" alt="Img">
                                    <div class="portfolio-hover">
                                        <div class="hover-content">
                                            <a href="#" class="cat-btn">Design</a>
                                            <h4><a href="project-details.html">Creative Arts</a></h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-4 cat-3">
                            <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-holder">
                                    <img src="{{asset('/')}}frontend/main/assets/images/portfolio/img-13.jpg" alt="Img">
                                    <div class="portfolio-hover">
                                        <div class="hover-content">
                                            <a href="#" class="cat-btn">Design</a>
                                            <h4><a href="project-details.html">Creative Arts</a></h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-5 cat-1">
                            <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".5s">
                                <div class="img-holder">
                                    <img src="{{asset('/')}}frontend/main/assets/images/portfolio/img-14.jpg" alt="Img">
                                    <div class="portfolio-hover">
                                        <div class="hover-content">
                                            <a href="#" class="cat-btn">Design</a>
                                            <h4><a href="project-details.html">Creative Arts</a></h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-4 cat-2">
                            <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".6s">
                                <div class="img-holder">
                                    <img src="{{asset('/')}}frontend/main/assets/images/portfolio/img-15.jpg" alt="Img">
                                    <div class="portfolio-hover">
                                        <div class="hover-content">
                                            <a href="#" class="cat-btn">Design</a>
                                            <h4><a href="project-details.html">Creative Arts</a></h4>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="text-wrapper mb-40 wow fadeInLeft">
                                    <h2>Want to Grow Your Restaurant Online?</h2>
                                    <p>Get in touch with us to start your subscription and unlock the full potential of your restaurant with our all-in-one SaaS platform.</p>
                                    ...
                                    <div class="information-style-two d-flex mb-20">
                                        ...
                                        <div class="info">
                                            ...
                                            <h4><a href="mailto:support@restaurant-saas.com">support@restaurant-saas.com</a></h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="information-style-two d-flex mb-20">
                                        ...
                                        <div class="info">
                                            <h5 class="blue-dark">Call Us</h5>
                                            <h4><a href="tel:+0123456789">+012 (345) 6789</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form_group">
                                                    <select class="wide">
                                                        ...
                                                        <option value="01">Subscription Inquiry</option>
                                                        <option value="02">Demo Request</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
            ...
            <section class="counter-area counter-area-v2 pb-90">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="section-title text-center mb-55 wow fadeInUp">
                                <h2>Why Restaurant Owners Love Us</h2>
                                <p>All-in-one SaaS platform to manage and grow your restaurant</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="counter-item mb-40 wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div class="text">
                                    <h2 class="number"><span>1,200</span>+</h2>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="counter-item mb-40 item-active wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <div class="text">
                                    <h2 class="number"><span>50,000</span>+</h2>
                                    <p>Online Orders Processed</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="counter-item mb-40 wow fadeInUp" data-wow-delay=".4s">
                                ...
                                <div class="text">
                                    <h2 class="number"><span>95%</span></h2>
                ...
                <div class="container">
                    ...
                    <div class="partners-wrapper wow fadeInUp">
                        <div class="partner-item">
                            <div class="img-holder">
                                <a href="#"><img src="{{asset('/')}}frontend/main/assets/images/partners/img-1.png" alt=""></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="img-holder">
                                <a href="#"><img src="{{asset('/')}}frontend/main/assets/images/partners/img-2.png" alt=""></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="img-holder">
                                <a href="#"><img src="{{asset('/')}}frontend/main/assets/images/partners/img-3.png" alt=""></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="img-holder">
                                <a href="#"><img src="{{asset('/')}}frontend/main/assets/images/partners/img-4.png" alt=""></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="img-holder">
                                <a href="#"><img src="{{asset('/')}}frontend/main/assets/images/partners/img-5.png" alt=""></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="img-holder">
                                <a href="#"><img src="{{asset('/')}}frontend/main/assets/images/partners/img-6.png" alt=""></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="img-holder">
                                <a href="#"><img src="{{asset('/')}}frontend/main/assets/images/partners/img-7.png" alt=""></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="img-holder">
                                <a href="#"><img src="{{asset('/')}}frontend/main/assets/images/partners/img-8.png" alt=""></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="img-holder">
                                <a href="#"><img src="{{asset('/')}}frontend/main/assets/images/partners/img-9.png" alt=""></a>
                            </div>
                        </div>
                        <div class="partner-item">
                            <div class="img-holder">
                                <a href="#"><img src="{{asset('/')}}frontend/main/assets/images/partners/img-10.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="img-holder mb-55 wow fadeInLeft">
                                <img src="{{asset('/')}}frontend/main/assets/images/testimonial/img-2.jpg" alt="Happy Restaurant Owner">
                            </div>
                        </div>
                        <div class="col-lg-7">
                                ...
                                <div class="testimonial-slider-two mb-55">
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testimonial-content">
                                            ...
                                            <h3>"This platform helped me manage online orders and grow my restaurant business effortlessly. Highly recommended!"</h3>
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testimonial-content">
                                            <div class="quote-rating d-flex justify-content-between align-items-center">
                                                ...
                                                <ul class="ratings">
                                                    <li><span>Easy & Efficient</span></li>
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><i class="fas fa-star"></i></li>
                                            ...
                                            <h3>"Managing my menu and tracking orders has never been easier. The analytics help me make smart business decisions."</h3>
                                            <div class="author-title">
                                                <h4>Arjun Patel</h4>
                                                <p class="position">Restaurant Owner</p>
                                            </div>
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testimonial-content">
                                            <div class="quote-rating d-flex justify-content-between align-items-center">
                                                ...
                                                <ul class="ratings">
                                                    <li><span>Reliable Platform</span></li>
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><i class="fas fa-star"></i></li>
                                            ...
                                            <h3>"From website setup to order management, everything is seamless. Our customers love the online experience!"</h3>
                                            <div class="author-title">
                                                <h4>Sahana Roy</h4>
                                                <p class="position">Restaurant Owner</p>
                                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="section-title text-center mb-55">
                                    ...
                                    <p>Flexible subscription plans to grow your restaurant digitally</p>
                                </div>
                            </div>
                        </div>
        ...
        <!--====== Jquery js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/jquery-3.6.0.min.js"></script>
        <!--====== Bootstrap js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/popper/popper.min.js"></script>
        <!--====== Bootstrap js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
        <!--====== Slick js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/slick/slick.min.js"></script>
        <!--====== Magnific js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
        <!--====== Isotope js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/isotope.min.js"></script>
        <!--====== Imagesloaded js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/imagesloaded.min.js"></script>
        <!--====== Counterup js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/jquery.counterup.min.js"></script>
        <!--====== Waypoints js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/jquery.waypoints.js"></script>
        <!--====== Nice-select js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/nice-select/js/jquery.nice-select.min.js"></script>
        <!--====== WOW js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/wow.min.js"></script>
        <!--====== Parallax js ======-->
        <script src="{{asset('/')}}frontend/main/assets/vendor/parallax.min.js"></script>
        <!--====== Main js ======-->
        <script src="{{asset('/')}}frontend/main/assets/js/theme.js"></script>
    </body>
</html>
